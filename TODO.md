...
- Active sub-step: **2.3b — Implement the allowlisted validation catalog and diagnostic core**
- Status: In progress
...
- **2.3b — In progress:** Implement the allowlisted validation catalog and normalized diagnostic core.
  ...
  - Intended commit: `feat(schema): add strict validation and diagnostics core`.
