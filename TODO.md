...
- Active sub-step: **2.3c — Implement immutable defaults normalization and sequential v1 migration pipeline**
- Status: In progress
...
- **2.3c — In progress:** Implement immutable defaults normalization and sequential v1 migration pipeline.
  ...
  - Targeted files: the existing `packages/ui/src/schema/**` types/runtime/tests and schema barrel; the UI public barrel only for intentional stable contracts; root test/coverage configuration only if inclusion requires it; and `TODO.md`.
  ...
  - Intended commit: `feat(schema): add immutable normalization and migration pipeline`.
