...
- Active sub-step: **2.1a — Replace legacy CDN dependencies with package-local assets**
- Status: In progress
...
- **2.1a — In progress:** Replace legacy CDN dependencies with package-local assets.
  ...
  - Intended commit: `fix(editor): load legacy dependencies from local assets`.
